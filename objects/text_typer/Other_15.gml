...
ds_map_add(_map_macro,"FONT.MERCY",3);
...
_group_font[3,0]=font_smash_creeper;
_group_font_scale_x[3,0]=real(Lang_GetString("font.mercy.0.scale.x"));
_group_font_scale_y[3,0]=real(Lang_GetString("font.mercy.0.scale.y"));
_group_font_space_x[3,0]=real(Lang_GetString("font.mercy.0.space.x"));
_group_font[3,1]=Lang_GetFont(Lang_GetString("font.mercy.1"));
_group_font_scale_x[3,1]=real(Lang_GetString("font.mercy.1.scale.x"));
_group_font_scale_y[3,1]=real(Lang_GetString("font.mercy.1.scale.y"));
_group_font_space_x[3,1]=real(Lang_GetString("font.mercy.1.space.x"));
_group_font_space_y[3]=real(Lang_GetString("font.mercy.space.y"));
